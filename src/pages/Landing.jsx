...
import Testimonials from "../Generic/Testimonials";
      ...
      <main className="m-12">
        <div className="flex  w-[1440] ">
          ...
          <div>
            ...
            <p>
              ...
              heartbeat of everything we do.We believe the future belongs to
        ...
        <div>
          <div>
            <img
              src={Vector}
              className="bg-orange-500 w-10 p-2 rounded-full"
              alt=""
            />
