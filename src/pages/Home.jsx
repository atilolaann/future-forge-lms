...
function Home (){
    return(
        ...
        <div className="max-w-7xl mx-auto px-8">
            ...
            <header className="flex gap-12 w-full max-w-full items-center justify-between mt-4  py-6">
            ...
            <main className=" flex gap-8 ">
                <div className="py-24">
                    ...
                    <p className="my-6">One central space for Forgers to access learning resources, <br />
                    Watch session recordings, track cohort progress.</p>
                    <button className="bg-orange-400 text-white px-6 py-2 rounded-lg">Begin Journey</button>

                </div>
                <img src={landingpage2} className="max-w-90 h-auto" alt="" />
            </main>
            </div>
