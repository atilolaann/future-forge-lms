...
function Recordingscard() {
  return (
    <div className="w-full h-full">
      <div className="m-0 sm:m-2 p-4 sm:p-6 w-full h-full bg-white rounded-2xl border border-l-4 border-l-orange-400 border-gray-100 shadow-sm flex flex-col justify-between hover:-translate-y-1 hover:shadow-md hover:border-orange-200 transition-all duration-300">
        <div>
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 py-2 sm:py-4">
            Recordings
          </h2>
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 pb-4 sm:pb-4 items-start sm:items-center">
