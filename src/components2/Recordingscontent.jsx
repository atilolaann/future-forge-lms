                                ...
                                {loading ? (
                                    ...
                                    <div>
                                        {recordings.map((recording) =>(
                                            <div
                                            key={recording._id}
                                            className='border border-gray-300 rounded-lg p-4 w-full shadow-inner flex items-center 
                                            justify-between gap-2 cursor-pointer'>
                                                <div className='flex gap-4 '>
                                                    <img
                                                     src={`https://img.youtube.com/vi/${new URL(recording.url).searchParams.get("v")}/0.jpg`} alt={recording.title}
                                                     ...
                                                     <div className='flex flex-col flex-1 gap-4 justify-between'>
                                                        ...
                                                        <p className='text-gray-600'>{recording.trackid?.name}</p>
                                                        <p className='text-gray-500 text-sm'>{recording.duration}</p>
