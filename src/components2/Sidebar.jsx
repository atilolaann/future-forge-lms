    ...
    <>
      ...
      >
        <button onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
          <div className="w-10 h-10 bg-gray-50 border border-gray-200 p-2 rounded-xl shadow-sm hover:bg-linear-to-b from-[#F59E0B] via-[#F5891E] to-[#F67430] hover:shadow-md hover:border-transparent transition-all duration-200 cursor-pointer">
            <img src={isSidebarOpen ? X : List} alt="" className="w-full h-full object-contain" />
          </div>
        </button>
        <div className="flex flex-col gap-4 w-full">
          <NavLink to="/dashboard">
            {({ isActive }) => (
              <div
                className={`group flex items-center rounded-lg transition-all duration-200 cursor-pointer ${isSidebarOpen
                    ? "gap-3 px-3 py-2 "
                    : "justify-center py-3 "
                  }
              ${isActive
