...
function Welcomecard() {
  return (
    <div className="w-full ">
      <div className="m-0 sm:m-2 p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between w-full h-full border border-gray-300 rounded-lg shadow-inner hover:-translate-y-3 hover:shadow-lg transition-all duration-300">
        <div>
